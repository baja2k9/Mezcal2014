...
class CCD_MARCONI4(CCD_ESOPO):
    'Clase para uso del CCD Marconi4 con electronica de Astronomical Researh Camera '
    def __init__(self):
        CCD.__init__(self)
        self.tipo="e2vm4"
        self.label="E2V (2k x 2k) Marconi4"
        self.label2="E2V CCD-4240 "
        ...
        self.usuario="Marconi4_ccd class"
        ...
        self.INIT_COMMAND="INIT_MARCONI4 "
        self.INIT_MSG="CCD INIT_4240 Marconi4  from Astronomical research Cameras"
...
############################################################################
    def pre_expone(self):
        self.clear_ccd(1)
############################################################################
print "Class CCD Marconi4 Ready.........."
