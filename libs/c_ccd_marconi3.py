...
class CCD_MARCONI3(CCD_ESOPO):
    'Clase para uso del CCD Marconi3 con electronica de Astronomical Researh Camera '
    def __init__(self):
        CCD.__init__(self)
        self.tipo="e2vm3"
        self.label="E2V (2k x 2k) Marconi3"
        self.label2="E2V-4240 deep depletion"
        ...
        self.usuario="Marconi3_ccd class"
        ...
        self.INIT_COMMAND="INIT_MARCONI3 "
        self.INIT_MSG="CCD INIT_4240 Marconi3  from Astronomical research Cameras"
...
############################################################################
    def update_extra_header(self):
        ...
        print "extra header del Marconi3"
...
############################################################################
    def pre_expone(self):
        self.clear_ccd(4)
############################################################################
print "Class CCD Marconi3 Ready.........."
