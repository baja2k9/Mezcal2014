...
class CCD_TH2K(CCD,CLIENTE):
    'Clase para uso del CCD Thompson '
    def __init__(self):
        CCD.__init__(self)
...
############################################################################
    def inicializa(self):
        ...
        self.mis_variables.mensajes("CCD INIT TH2K ")
        data,status=self.manda("INIT TH2K ")
        if not status:
            print "bad"
            print data
