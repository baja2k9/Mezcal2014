...
class CCD_MARCONI5(CCD_ESOPO):
    'Clase para uso del CCD Marconi5 con electronica de Astronomical Researh Camera '
    def __init__(self):
        CCD.__init__(self)
        self.tipo="e2vm5"
        self.label="E2V (2k x 2k) Marconi5"
        self.label2="E2V CCD-231-42 "
        self.xsize_total=2048
        self.ysize_total=2064
        ...
        self.output=4    #Num canales de salida
        self.n_output=4    #Num canales de salida
        self.default_output=2    #Num canales de salida
        self.output_actual=self.default_output

        self.INIT_COMMAND="INIT_MARCONI5 "
        self.INIT_MSG="CCD INIT_231-42 Marconi5  from Astronomical research Cameras"

        #control de temperaturas
        self.temp=-120.0
        self.temp_hilimit=-125
        self.temp_lowlimit=-101
...
############################################################################
    def update_extra_header(self):
        ...
        print "extra header del Marconi4"
...
############################################################################
    def cambia_salida(self):
        ...
        if self.output[0]=='Left':
            ...
            mando='AMPLI_LR '
        elif self.output[0]=='A':
            mando='AMPLI_A '
        elif self.output[0]=='B':
            mando='AMPLI_B '
        elif self.output[0]=='C':
            mando='AMPLI_C '
        elif self.output[0]=='D':
            mando='AMPLI_D '
        elif self.output[0]=='QUAD':
            mando='AMPLI_QUAD '
...
############################################################################
print "Class CCD Marconi5 Ready.........."
